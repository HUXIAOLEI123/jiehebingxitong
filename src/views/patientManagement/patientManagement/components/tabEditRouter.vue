  ...
  <div class="room">
    <div class="content">
      ...
      <el-row :gutter="2">
        ...
        <el-col :span="3">
          <span>今日服药状态:</span>
          <span :class="form.IsTakeMedicine ? 'fontyistyle' : 'fontstyle'">{{ form.IsTakeMedicine ? '已服' : '未服' }}</span>
        </el-col>

        <el-col :span="3">
          <div class="backgroudsty">
            <span style="color: #fff">结核病类型:</span>
            <span style="color: #fff">{{ form.DiagnosisTypeName }}</span>
          </div>
        </el-col>

        <el-col :span="3">
          <span>医生:</span>
          <span class="spn">{{ form.ResponsibilityName }}</span>
        </el-col>

        <el-col :span="5">
          <span>治疗方案:</span>
          <span class="spn">{{ form.TreatmentPlanName }}</span>
        </el-col>
      </el-row>
      <!-- tab栏 -->
      <template>
