  ...
  <el-dialog :title="title" :visible.sync="innerVisible" :close-on-click-modal="false" width="60%" @close="close" append-to-body top="5vh">
    ...
    <el-form class="form_row" ref="form" :model="form" :rules="rules" label-width="120px">
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="检查结果日期:" prop="InspectResultTime">
            <el-date-picker
...
import { fileStorageInfoupload, fileStorageInfolist, fileStorageInfodeletes } from "@/api/FileStorageInfo.js";
import { InspectApplicationeModify2, InspectApplicationresult } from '@/api/InspectApplication.js'
export default {
  name: "Edit",
  data () {
    return {
