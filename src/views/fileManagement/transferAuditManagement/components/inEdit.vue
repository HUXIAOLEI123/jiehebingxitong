<template>
	<el-dialog :title="title" :visible.sync="dialogVisible" :close-on-click-modal="false" width="60%" top="5px"
		@close="close">
        ...
        <span>{{ form.FileNumber }}</span>
			...
			<el-row :gutter="20">
				...
				<el-col :span="10">
					<el-form-item label="转出机构">
						<span>{{ form.FormerOrganizationName }}</span>
					</el-form-item>
				</el-col>
			...
			<div class="detailstitlo">
				<p class="xqtitolstyle">转入申请</p>
			</div>
			<el-row :gutter="20">
				<el-col :span="10">
					<el-form-item label="申请机构">
						<span>{{ form.MoveOrganizationName }}</span>
					</el-form-item>
				</el-col>
				<!--  -->
				...
				<el-col :span="10">
					<el-form-item label="申请日期">
						<span>{{ form.OperateTimeFirst | parseTime("{y}-{m}-{d}")  }}</span>
					</el-form-item>
				</el-col>
			</el-row>
			...
			<el-row :gutter="20">
				<el-col :span="10">
					<el-form-item label="申请人员">
						<span>{{ form.FormerResponsibilityName }}</span>
					</el-form-item>
				</el-col>
			...
			<div class="detailstitlo">
				<p class="xqtitolstyle">转入审核</p>
			</div>
			<el-row :gutter="20">
				<el-col :span="10">
					<el-form-item label="审核结果">
						<span>{{ form.AuditStatus=='1'?'合格':'不合格'}}</span>
					</el-form-item>
				</el-col>
